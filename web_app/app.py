...
TELEGRAM_REPORT_START_MINUTE = max(0, min(59, int(os.getenv("TELEGRAM_REPORT_START_MINUTE", "0"))))
TELEGRAM_REPORT_END_HOUR = int(os.getenv("TELEGRAM_REPORT_END_HOUR", "22"))
TELEGRAM_REPORT_END_MINUTE = max(0, min(59, int(os.getenv("TELEGRAM_REPORT_END_MINUTE", "0"))))
TELEGRAM_REPORT_INTERVAL_MINUTES = max(1, min(60, int(os.getenv("TELEGRAM_REPORT_INTERVAL_MINUTES", "30"))))
TELEGRAM_REPORT_ALWAYS_ON = (os.getenv("TELEGRAM_REPORT_ALWAYS_ON", "0") or "0").strip().lower() in {
    "1",
    "true",
    "yes",
    "on",
...
AI_CHAT_MODEL = (os.getenv("AI_CHAT_MODEL") or "llama-3.3-70b-versatile").strip() or "llama-3.3-70b-versatile"
